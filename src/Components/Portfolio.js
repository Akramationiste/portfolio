...
const Portfolio = () => {
  ...
  return (
    <div className='mt-5 flex justify-center flex-col'>
        ...
        <span className='text-bluea'>{AppText.Portfolio}</span></h1> */}
        ...
        <div className='flex flex-row justify-evenly gap-2 px-4 md:px-72'>
            <button onClick={()=>filterPortfolio('All')} className='border-bluea border-2 
            text-bluea focus:text-white
            active:bg-bluea p-1 px-4 rounded-md
            focus:ring-violet-300 focus:bg-bluea focus:ring '>All</button>
             <button  onClick={()=>filterPortfolio('ui/ux')}  className='border-bluea border-2 
            text-bluea focus:text-white
            active:bg-bluea p-1 px-4 rounded-md
            focus:ring-violet-300 focus:bg-bluea focus:ring '>UI/UX</button>
             <button onClick={()=>filterPortfolio('website')} className='border-bluea border-2 
            text-bluea focus:text-white
            active:bg-bluea p-1 px-4 rounded-md
            focus:ring-violet-300 focus:bg-bluea focus:ring '>Web App</button>
             <button onClick={()=>filterPortfolio('mobile')} className='border-bluea border-2 
            text-bluea focus:text-white
            active:bg-bluea p-1 px-4 rounded-md
            focus:ring-violet-300 focus:bg-bluea focus:ring '>Mobile App</button>
        </div>
