...
const AboutMe = () => {
  return (
    <div id="aboutme" className='mt-[100px]'>
        ...
        <div className='w-full bg-bluea h-[300px]  justify-center items-center'>
        <div className='flex flex-row justify-between absolute'>
            <img src={laptop}  className="w-[150px] md:w-[300px] mt-[-100px] " />
        </div>
            <h1 className='text-white text-[50px] pt-[20px] font-bold text-center'>About <span className='text-blue-500'>Me</span></h1>
        ...
        <div className='flex flex-col md:flex-row mt-[-75px] md:px-32 '>
           {
            aboutSection.map((item,index)=>(
                ...
                group md:hover:bg-blue-500 rounded-lg py-2">
